      ...
      <section className="border-b border-white/10 bg-[#1F2937]">
        <div className="container mx-auto px-4 py-10">
          ...
          <p className="mt-3 text-gray-400">
            Retrouvez rapidement les sessions que
            vous avez mises de côté pendant votre
            exploration.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-10">
        {loading ? (
          ...
          <div className="mx-auto max-w-lg rounded-lg border border-white/10 bg-[#1F2937] px-6 py-14 text-center shadow-sm">
            ...
            <p className="mt-3 text-gray-400">
              Ajoutez des sessions à vos favoris
              pour les retrouver ici en un clic.
            </p>
          ...
          <>
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Link
                href="/sessions"
                className="text-sm font-semibold text-[#10B981] hover:text-[#10B981]"
              >
